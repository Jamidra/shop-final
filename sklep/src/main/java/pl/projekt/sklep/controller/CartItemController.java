...
public class CartItemController {
    ...
    public String addItemToCart (@RequestBody AddItemToCartRequest request){
        cartItemService.addItemAndInitialize(request.getCartId(), request.getItemId(), request.getQuantity());
    ...
    @DeleteMapping("/cart/remove_by_id")
    ...
    public String updateItemQuantity(
        ...
        cartItemService.updateItemQuantity(request.getCartId(), request.getItemId(), request.getQuantity());
